    ...
    <div className="row justify-content-center align-content-center h-100">
      ...
      {({ errors, touched }) => (
        <Form className="col-12 col-md-6 mt-3 mt-mb-0">
          ...
          <Field name="password" type="password" className="form-control" placeholder="Пароль"/>
